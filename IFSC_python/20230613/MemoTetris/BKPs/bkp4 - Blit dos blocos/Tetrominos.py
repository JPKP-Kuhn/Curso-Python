...
class Tetromino: #Indica o tetromino e a rotacao que sofre.	
	'''
	for i in range(7): 	#Sao 7 blocos. 
		RetBloco = pyg.Rect( (i*BlocosCores.get_width(),0)  , (BlocosCores.get_width(),BlocosCores.get_height())  )
		self.SurfBlocos[i] = pyg.Surface(Trama)
	...
	def Tetros(self): 					
		...
		self.SurfTetros = []#Guarda as superficies dos tetrominos.
		self.Tetro1()				
		self.Tetro2()
		self.Tetro3()
		self.Tetro4()
	...
	def Tetro8(self):
		Tetro = {}
		self.SurfTetro = {}#Guarda superficie para o tetromino. 	
		#Posicao 0
